...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-ajax-textarea', __webpack_require__(3));
    Vue.component('detail-ajax-textarea', __webpack_require__(6));
    Vue.component('form-ajax-textarea', __webpack_require__(9));
});
